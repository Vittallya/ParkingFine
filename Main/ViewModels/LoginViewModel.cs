...
namespace Main.ViewModels
{
    public class LoginViewModel : BasePageViewModel
    {
        ...
        public LoginViewModel(ILoginService loginService, PageService pageService, IDeclarationService declarationService) : base(pageService)
        {
        ...
        public ICommand LoginCommand => new Command(x =>
        {
            ...
            {
                pageService.ChangePage<Pages.DeclarationPage>(DisappearAndToSlideAnim.ToLeft);
            }
            else
            {
                IsErrorVisible = true;
